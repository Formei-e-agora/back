...
exports.update = asyncHandler(async (req, res) => {
  ...
  return res.json({ Status: true, addressData: result[0] }).end();
});
...
exports.findByPerson = asyncHandler(async (req, res) => {
  const result = await addressDao.findByPersonId(Address, req.params.personId);
